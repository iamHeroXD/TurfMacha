      ...
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
            <div className="w-14 h-14 rounded-full bg-[#0B3D2E]/8 border-2 border-[#0B3D2E]/15 flex items-center justify-center mx-auto mb-4">
              <CheckCircle2 className="h-7 w-7 text-[#0B3D2E]" />
            </div>
            <h1 className="text-xl font-display font-bold text-[#1F2937] mb-2">Check your inbox</h1>
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-1.5">
                <Label className="text-[#1F2937] text-sm font-medium">Email</Label>
                <Input
                  type="email"
