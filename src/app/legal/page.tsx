  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-display font-bold text-[#0B3D2E] mb-4">Privacy Policy & Terms</h1>
        <p className="text-[#1F2937]/55 mb-12">Last updated: January 2025</p>

        <div className="space-y-12">
          <section className="bg-white rounded-2xl p-8 border border-gray-100">
            <h2 className="text-2xl font-display font-bold text-[#0B3D2E] mb-4">Privacy Policy</h2>
            <div className="space-y-4 text-[#1F2937]/70 text-sm leading-relaxed">
              <p>
                TurfMacha (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy
                explains how we collect, use, and safeguard your information.
              </p>
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Information We Collect</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">How We Use Your Information</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Data Security</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Contact</h3>
              <p>For privacy-related questions, email us at privacy@turfmacha.com.</p>
            </div>
          </section>

          <section className="bg-white rounded-2xl p-8 border border-gray-100">
            <h2 className="text-2xl font-display font-bold text-[#0B3D2E] mb-4">Terms of Service</h2>
            <div className="space-y-4 text-[#1F2937]/70 text-sm leading-relaxed">
              <p>By using TurfMacha, you agree to these terms. Please read them carefully.</p>
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Bookings</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Payments</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">User Conduct</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Turf Owners</h3>
              ...
              <h3 className="font-display font-bold text-[#1F2937] text-base mt-6">Changes to Terms</h3>
