    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#F4F1EB]">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 p-0.5 text-[#9E9284] hover:text-[#5F5F5F] transition-colors"
              >
          ...
          <div className="space-y-1.5">
            <Label className="text-[#111111] text-sm font-medium">Confirm New Password</Label>
            <Input
              type="password"
