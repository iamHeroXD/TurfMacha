    ...
    <div className="min-h-screen bg-[#FAF7F0] pt-32 pb-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0B3D2E]/10 text-[#0B3D2E] font-medium text-sm mb-6 border border-[#0B3D2E]/20">
            Our Story
          </div>
          <h1 className="text-4xl md:text-5xl font-display font-bold text-[#0B3D2E] mb-6 leading-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center mb-20">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-[#0B3D2E]/10 to-[#A3E635]/10 rounded-3xl transform -rotate-2" />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="https://images.unsplash.com/photo-1575361204480-aadea25e6e68?auto=format&fit=crop&q=80&w=1200"
              alt="Football turf"
              className="rounded-3xl shadow-xl relative z-10 object-cover h-[380px] w-full"
            />
          </div>
          <div>
            <h2 className="text-3xl font-display font-bold text-[#0B3D2E] mb-5">From Trivandrum, for Kerala</h2>
            <div className="space-y-4 text-[#1F2937]/70 leading-relaxed">
              <p>
        ...
        {/* Values */}
        <div className="mb-20">
          <h2 className="text-3xl font-display font-bold text-center text-[#1F2937] mb-12">What we stand for</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {VALUES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex gap-5">
                <div className="w-12 h-12 bg-[#FAF7F0] rounded-2xl flex items-center justify-center shrink-0">
        ...
        {/* CTA */}
        <div className="bg-[#0B3D2E] rounded-[2.5rem] p-10 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#A3E635]/15 rounded-full blur-3xl pointer-events-none" />
          <div className="relative z-10">
            ...
            <Link href="/turfs">
              <button className="bg-[#A3E635] text-[#0B3D2E] font-display font-bold px-8 py-4 rounded-full text-base hover:bg-[#B8E872] transition-colors shadow-lg inline-flex items-center gap-2">
