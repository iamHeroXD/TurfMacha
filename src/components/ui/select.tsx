...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-xl border border-white/10",
      "bg-white/5 px-4 py-2 text-sm text-white placeholder:text-white/30",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-white/10 bg-[#0f0f23]/95 backdrop-blur-xl text-white shadow-2xl",
