  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border border-white/[0.08] bg-[#161616] text-white shadow-xl shadow-black/40",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-7 pr-2 text-xs font-semibold text-white/40 uppercase tracking-wider", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-md py-2 pl-7 pr-3 text-sm text-white/70",
      "focus:bg-white/[0.06] focus:text-white focus:outline-none",
